...
## Cron (find og del din opsætning)

For at finde ud af hvordan cron er sat op på din maskine, kan du kopiere
outputtet fra disse kommandoer og sende det videre:

```bash
crontab -l
```

Hvis der ikke ligger noget i din egen crontab, kan der også være system-cron:
